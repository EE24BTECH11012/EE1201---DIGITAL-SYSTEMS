\section{Multiplying Out and Factoring Expressions}
...
\begin{itemize}
\item
    $(Q + AB^\prime)(C^\prime D + Q^\prime) $ \\
     \begin{align}
    &= QC^\prime D + QQ^\prime + AB^\prime C^\prime D + AB^\prime Q^\prime \\
    &= QC^\prime D + AB^\prime C^\prime D
 \end{align}
 \item
    ...
    &\text{Using \ref{eq:2}}\\
     \begin{align}
    	...
    	\end{align}
    \text{Using \ref{eq:2} and \ref{eq:3}}\\
    \begin{align}
